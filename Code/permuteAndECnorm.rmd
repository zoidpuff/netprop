...
mapping <- data.table::fread("/home/gummi/netprop/data/ensmbleIDtoNameAndNCBI.txt", data.table = F)
ensemblIdtoName <- setNames(mapping$`Gene name`, mapping$`Gene stable ID`)
ensemblIdtoName[names(head(sort(desc(ECvec$vector)),20))]
