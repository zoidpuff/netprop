...
distFuncsT <- c("euclidean", "manhattan", "cosine", "cosineSharp2", "pearson",
                "minkowski05", "spearman", "kendall","jsd")
...
plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirIndiMergedFiltered"]][["noNorm"]][["0"]][["FALSE"]][["FALSE"]][["jsd"]],diseaseMapping)
...
### NO NORM Cosine Centered

```{r fig.height=8, fig.width=10, warning=FALSE}

plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirIndiMergedFiltered"]][["noNorm"]][["0"]][["TRUE"]][["FALSE"]][["cosine"]],diseaseMapping)

ggplotly(plots[["Plot_Leiden_UMAP"]])

```

### Permutation Norm Kendall

```{r fig.height=8, fig.width=10, warning=FALSE}

plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirIndiMergedFiltered"]][["permuteNormDegree"]][["0"]][["FALSE"]][["FALSE"]][["kendall"]],diseaseMapping)
...
plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirectFiltered"]][["noNorm"]][["0"]][["TRUE"]][["FALSE"]][["cosine"]],diseaseMapping)

ggplotly(plots[["Plot_Leiden_UMAP"]])

```

## ECnorm Cosine Centered

```{r fig.height=8, fig.width=10, warning=FALSE}

plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirectFiltered"]][["ECnormLog"]][["0"]][["TRUE"]][["FALSE"]][["cosine"]],diseaseMapping)
...
plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirectFiltered"]][["ECnormLog"]][["0"]][["FALSE"]][["FALSE"]][["kendall"]],diseaseMapping)
...
plots <- generatePlotsFromDistCompareResults(masterRes[["assocDataBySourceDirectFiltered"]][["noNorm"]][["0"]][["FALSE"]][["FALSE"]][["euclidean"]],diseaseMapping)
